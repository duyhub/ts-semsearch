...
| `docs/mobility-track-briefing-recap.md` | Sponsor kickoff-briefing excerpts (verbatim): expected query types & Vietnamese behaviors (typos, coordinates, ambiguous names...), track Q&A **confirming a private judging eval set**, mapping to PRD requirements |
